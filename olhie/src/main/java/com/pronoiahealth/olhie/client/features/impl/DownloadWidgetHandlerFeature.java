...
/**
 * DownloadWidgetHandlerFeature.java<br/>
 * Responsibilities:<br/>
 * 1.
 * 
 ...
 */
@Dependent
public class DownloadWidgetHandlerFeature extends
		AbstractWidgetBasedListenerClientFeature {
	
	@Inject
	private Instance<DownloadFrame> instFactory; 
	 ...
	 */
	@Inject
	public DownloadWidgetHandlerFeature() {
	}
