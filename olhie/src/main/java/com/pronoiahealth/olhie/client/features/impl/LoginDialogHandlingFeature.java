...
import com.pronoiahealth.olhie.client.features.dialogs.LoginDialog;

/**
 * LoginDialogHandlingFeature.java<br/>
 * Responsibilities:<br/>
 * 1.
 * 
 ...
 */
@Dependent
public class LoginDialogHandlingFeature extends
		AbstractWidgetBasedListenerClientFeature {

	@Inject
	private Instance<LoginDialog> instFactory;
	 ...
	 */
	@Inject
	public LoginDialogHandlingFeature() {
	}
