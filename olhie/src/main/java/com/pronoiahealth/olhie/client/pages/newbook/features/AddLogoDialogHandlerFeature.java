...
/**
 * AddLogoDialogHandlerFeature.java<br/>
 * Responsibilities:<br/>
 * 1.
 * 
 ...
 */
@Dependent
public class AddLogoDialogHandlerFeature extends
		AbstractWidgetBasedListenerClientFeature {

	@Inject
	private Instance<AddLogoDialog> instFactory;

	/**
	 * Constructor
	 * 
	 */
	public AddLogoDialogHandlerFeature() {
	}
