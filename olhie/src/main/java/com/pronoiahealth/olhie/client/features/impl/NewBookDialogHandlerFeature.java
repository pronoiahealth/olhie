...
import com.pronoiahealth.olhie.client.features.dialogs.NewBookDialog;

/**
 * NewBookDialogHandlerFeature.java<br/>
 * Responsibilities:<br/>
 * 1.
 *
 ...
 */
@Dependent
public class NewBookDialogHandlerFeature extends
		AbstractWidgetBasedListenerClientFeature {
	
	@Inject
	private Instance<NewBookDialog> instFactory;
	 ...
	 * @param dialog
	 */
	public NewBookDialogHandlerFeature() {
	}
