...
/**
 * NewAssetDialogHandlerFeature.java<br/>
 * Responsibilities:<br/>
 * 1.
 * 
 ...
 */
@Dependent
public class NewAssetDialogHandlerFeature extends
		AbstractWidgetBasedListenerClientFeature {

	@Inject
	private Instance<NewAssetDialog> instFactory;

	/**
	 * Constructor
	 * 
	 */
	public NewAssetDialogHandlerFeature() {
	}
